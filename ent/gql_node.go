...
func (n *News) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     n.ID,
		Type:   "News",
		Fields: make([]*Field, 9),
	...
	if buf, err = json.Marshal(n.Description); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(n.Content); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(n.AuthorID); err != nil {
		return nil, err
	}
	node.Fields[8] = &Field{
		Type:  "uuid.UUID",
...
func (c *Client) noder(ctx context.Context, table string, id uuid.UUID) (Noder, error) {
	...
	case news.Table:
		query := c.News.Query().
			Where(news.ID(id))
		query, err := query.CollectFields(ctx, "News")
		if err != nil {
			return nil, err
		}
