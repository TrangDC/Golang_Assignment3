...
func (uc *UserCreate) AddNewsEdgeIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddNewsEdgeIDs(ids...)
	return uc
}

// AddNewsEdges adds the "news_edges" edges to the News entity.
func (uc *UserCreate) AddNewsEdges(n ...*News) *UserCreate {
	ids := make([]uuid.UUID, len(n))
	for i := range n {
		ids[i] = n[i].ID
	}
	return uc.AddNewsEdgeIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.NewsEdgesIDs(); len(nodes) > 0 {
